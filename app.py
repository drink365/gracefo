...
with g1:
    st.markdown("### 🤝 顧問式陪伴"); st.caption("不推銷商品，先理解人在傳承裡的位置與心願。")
with g2:
    st.markdown("### 📈 AI 快速洞察"); st.caption("用工具看見稅負與現金流缺口，決策更快更穩。")
with g3:
    st.markdown("### 🛡️ 合規與風控"); st.caption("導師協同會計師／律師，確保法律與稅務的穩健。")
